package uz.ahmadillo.springboottelegramboot.bot;
...
@Component
public class ExchangeRatestBot extends TelegramLongPollingBot {


    private static final Logger LOG = LoggerFactory.getLogger(ExchangeRatestBot.class);
    ...
    public ExchangeRatestBot(@Value("${bot.token}") String botToken, ExchangeRatesService exchangeRatesService) {
        super(botToken);
    ...
    private void usdCommand(Long chatId) {
        ...
        try {
            var eur = exchangeRatesService.getUSDExchangeRate();
